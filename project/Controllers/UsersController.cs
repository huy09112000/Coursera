...
namespace project.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var users = db.Users.Include(u => u.UserInfor);
        ...
        {
            ViewBag.Id = new SelectList(db.UserInfors, "Id", "Name");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,Password,Role,Avatar")] User user)
        {
            if (ModelState.IsValid)
            {
